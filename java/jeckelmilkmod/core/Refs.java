...
import jeckelmilkmod.common.UpdateChecker;
import jeckelmilkmod.common.configs.ConfigHandler;
...
public class Refs
{
	public static final String ModId = "jeckelmilkmod";
	public static final String ModName = "JeckelMilkMod";
